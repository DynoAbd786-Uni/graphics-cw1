...
#				endif
		...
		switch( testId )
		{
			...
			case 7: {
				// All points of triangle lie outside in different dreas of the drawable region
				draw_triangle_interp(surface,
					{ fbwidth + 100.f, fbheight + 100.f },
					{ fbwidth - 100.f, float(fbheight) },
					{ float(fbwidth), fbheight - 100.f},
					{ 1.f, 0.f, 0.f },
					{ 0.f, 1.f, 0.f },
					{ 0.f, 0.f, 1.f }
			...
			case 8: {
				// 2 point in 1 position "triangle"
				draw_triangle_interp(surface,
					{ fbwidth / 2.f, fbheight - 200.f },
					{ fbwidth - 100.f, fbheight - 100.f },
					{ fbwidth - 100.f, fbheight - 100.f },
					{ 1.f, 0.f, 0.f },
					{ 0.f, 1.f, 0.f },
			...
			case 9: {
				// Test case for standard triangle
				ColorF r = { 1.f, 0.f, 0.f };
				ColorF g = { 0.f, 1.f, 0.f };
				ColorF b = { 0.f, 0.f, 1.f };

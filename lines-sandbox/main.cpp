...
// imports for extension functions
...
#	endif
	...
	//SurfaceEx surface_ext(fbwidth, fbheight);
...
#				endif
				...
				surface = Surface( fbwidth, fbheight );
				//surface_ext = SurfaceEx(fbwidth, fbheight);
			}
		}
		...
		switch( testId )
		{
			...
			case 4: {
			//	// Using draw ext func
			//	draw_ex_line_solid( surface_ext, 
			//		{ fbwidth/2.f, fbheight/2.f }, { 150.f, 200.f },
			//		{ 255, 255, 0 }
			//	);
			//	context.draw(surface_ext);
			...
			case 6: {
				...
				Vec2f p0 = { -125.f, 500.f };
				Vec2f p1 = { 200.f, 200.f };

				draw_line_solid(surface, p0, p1, { 255, 0, 0 });
				context.draw(surface);
			...
			case 7: {
				...
				draw_line_solid(surface, p0, mp, { 255, 255, 255 });
				draw_line_solid(surface, mp, p1, { 255, 255, 255 });
			...
			//case 8: {
			//	// blit test
			//	std::unique_ptr<ImageRGBA> mEarthSprite = load_image("assets/earth.png");

			//	blit_ex_solid(surface_ext, *mEarthSprite, { fbwidth / 2.f, fbheight / 2.f });
			//	//blit_ex_solid(surface_ext, *mEarthSprite, { 501, 582 });
			//	context.draw(surface_ext);
			...
			//	blit_ex_memcpy(surface_ext, *mEarthSprite, { fbwidth / 2.f, fbheight / 2.f });
			//	context.draw(surface_ext);
			...
			//	blit_masked(surface, *mEarthSprite, { fbwidth / 2.f, fbheight / 2.f });
			//	context.draw(surface);
